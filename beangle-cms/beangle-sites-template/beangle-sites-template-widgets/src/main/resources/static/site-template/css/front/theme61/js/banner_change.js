...
function focusBox(o){
	...
	$infoLi.each(function(i){
		if(i==0){
			////arr.push('<li class="current"><span>'+ (i+1) +'<img src=images/pic_01.jpg></span></li>');
			////arr.push('<li class="current"><span>'+ (i+1) +'<img src=style_01/temp_'+(i+1)+'.jpg></span></li>');
			arr.push('<li class="current"><span><img src=/css/front/theme61/style_01/temp_'+(i+1)+'.jpg></span></li>');
		}else{
			////arr.push('<li><span>'+ (i+1) +'<img src=style_01/temp_'+(i+1)+'.jpg></span></li>');
			arr.push('<li><span><img src=/css/front/theme61/style_01/temp_'+(i+1)+'.jpg></span></li>');
		}
	});
	arr.push('</ul></div>');
	////$o.append(arr.join(''));
