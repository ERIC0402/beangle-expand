...
<div class="c_Right_2">
    <div class="list_box_3 border_right_1">
        <div class="position_bar">
            ...
            <h2 class="title_4">${(column.name)!'教师列表'}</h2>
            <#if contents??>
            <ul class="list_box_4">
                <#list contents as v>
                <li>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td valign="top" class="pic_box_2"><img src="<@url.getTitleImage cc=v/>"></td>
                            <td valign="top">
                                <h3>&middot;${v.content.title!}</h3>  
                                <@wv.textarea c=v.content.abstracts!/>
                               </td>
                        </tr>
                    </table>
                </li>
