...
[@b.form name="loginForm"  id="login_text" action="login" target="_top"]
    ...
    <tr>
    	<td class="td_1" align="right"><label for="username">用户名</label>：</td>
	    <td>
	    	<input name="username" id="username" tabindex="1" title="请输入用户名" type="text" class="ip_1" value="${name!}"/>
	    </td>
	</tr>
    <tr>
	    <td class="td_1" align="right"><label for="password">密&nbsp;&nbsp;码</label>：</td>
	    <td>
	    	<input id="password" name="password"  tabindex="2" type="password" class="ip_1" />
    ...
    <tr><td height="70" colspan="2" align="center">
    	[@b.submit name="submitBtn"  class="ip_2" value="登 录" onsubmit="checkLogin"][/@]
    	&nbsp;&nbsp;&nbsp;&nbsp;
